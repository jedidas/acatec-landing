@extends('layouts.app', ['css' => 'cart-section'])
@section('title')
    {{ $title }}
@endsection
...
@section('css')
    @viteReactRefresh
    @vite(['resources/sass/cart-favorites.scss', 'resources/ts/cart-favorites-app.tsx'])
@endsection
...
@section('content')
    <div class="mx-auto p-4 sm:px-6 lg:container pt-10">
        ...
        <article class="py-5 mb-20">
            ...
            @endphp
            <div class="cart-favorites-container" id="{{ $type }}-app">
...
@section('bottom-section')
    <section class="featured-section bg-amber-50 p-4 pb-10">
